...
/// </summary>
public partial class MediatorBehavior
{
    ...
    public MediatorBehavior AddHandler(object handler)
    {
        ...
        if (!requestHandlerInterfaces.Any())
        {
            throw new ArgumentException(
                $"The provideded handler object of type '{handler.GetType().Name}' does not implement '{nameof(IRequestHandler)}' interface for any request.");
        }

        foreach (var handlerType in requestHandlerInterfaces)
        {
            Handlers.Add(handlerType, handler);
        }
        return this;
    }
    ...
    public MediatorBehavior RemoveHandlerByHandlerType(Type handlerType)
    {
    ...
    /// <returns>The updated mediator behavior instance.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public MediatorBehavior RemoveHandlerByHandlerType<THandler>()
        where THandler : IRequestHandler
    ...
    /// <returns>The updated mediator behavior instance.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public MediatorBehavior RemoveHandlerByRequestType(Type requestType)
    {
    ...
    /// <returns>The updated mediator behavior instance.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public MediatorBehavior RemoveHandlerByRequestType<TRequest, TResponse>()
    ...
    /// <returns>The updated mediator behavior instance.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public MediatorBehavior RemoveHandlerByRequestType<TRequest>()
